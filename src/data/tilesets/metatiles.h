...
const u16 gMetatiles_myGame[] = INCBIN_U16("data/tilesets/primary/my_game/metatiles.bin");
const u16 gMetatileAttributes_myGame[] = INCBIN_U16("data/tilesets/primary/my_game/metatile_attributes.bin");

const u16 gMetatiles_base01[] = INCBIN_U16("data/tilesets/secondary/base_01/metatiles.bin");
const u16 gMetatileAttributes_base01[] = INCBIN_U16("data/tilesets/secondary/base_01/metatile_attributes.bin");
